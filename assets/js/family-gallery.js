...
function getPhotoTitle(index) {
    const titles = [
        "Family Gathering", "Cherished Moments", "Loving Support", 
        "Generations Together", "Warm Family Smiles", "Heartfelt Wishes",
        "Celebration with Family", "Joyful Reunion", "Memorable Day", 
        "Family Blessings", "Togetherness", "Happy Occasion"
    ];
