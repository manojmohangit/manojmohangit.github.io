...
function getPhotoTitle(index) {
    const titles = [
        "Celebration Gathering", "Honoring V. Sunil Kumar", "Heartfelt Welcomes", 
        "Milestones & Memories", "Warm Wishes & Smiles", "Distinguished Guests",
        "Legacy of Dedication", "New Beginnings", "Sharing Gratitude", 
        "Family & Friends", "Colleagues Tribute", "Joyful Occasion"
    ];
